...
# set directories
BAMFILE=/home/mchale/Documents/boreogadus/scripts/boreogadus_bamlist_plus_downsampled_Ice_cod12_onward.txt 	# path to textfile that lists all bamfiles with their path
OUTFILE=/home/mchale/Documents/boreogadus/depth/ # directory where depths per individual will be places
ARCTICBAM=/home/mchale/Documents/Arctic_cod/New_genome/Iceland_samples # directory where samples are, not sure if this is necessary
