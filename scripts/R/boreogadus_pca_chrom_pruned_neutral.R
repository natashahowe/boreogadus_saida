...
#### OPTIONS #########################################################
suffix = '_neutral_pruned_1MB_01'

WILDCARD = '*prun*1MB_01*'
...
popFID <- cbind(popFID, filter_df) %>% rename(Filter = V1)
...
theme_set(
  theme(legend.title=element_blank(), legend.text=element_text(size=10),
        ...
        axis.text = element_text(angle = 0, size = 9), axis.title = element_text(size = 9),
...
ggsave(paste0("./figures/pca/20241222/fusion/boreogadus_chroms",suffix,"_allIndivs.jpg"),
       plot = pcs12, width = 12, height = 12, units = "in")
...
ggsave(paste0("./figures/pca/20241222/fusion/boreogadus_unfused_chroms",suffix,"_removeFour.jpg"),
